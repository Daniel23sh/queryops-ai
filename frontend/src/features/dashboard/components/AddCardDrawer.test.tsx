...
function template() { return { id: "template", title: "Devices by scope", description: "Counts devices.", domain: "it", category: "Devices", natural_language_question: "Count devices by scope.", parameters: [], scope_type: "department", required_permission: "can_use_query_templates" }; }
function queryResult() { return { query_run_id: "query-run", status: "succeeded" as const, columns: ["department", "device_count"], rows: [{ department: "IT", device_count: 3 }], row_count: 1, duration_ms: 2, truncated: false, message: "Done", warnings: [], clarification_required: false, metadata: {} }; }
